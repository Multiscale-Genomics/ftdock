...
# OpenMPI library path in Marenostrum machine
FFTW_DIR        = /gpfs/apps/MN3/FFTW/2.1.5/OPENMPI
...
# Use of the OpenMPI compiler
CC		= mpicc

# Something more aggresive than -03 results in numerically unstable results
